...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        //CGSize dims = [self.labelText sizeWithFont:self.labelFont]; //deprecated
        ...
        if (nil != self.detailsLabelText) {
			...
			//CGSize labelSize = [detailsLabel.text sizeWithFont:detailsLabel.font
            //                                 constrainedToSize:CGSizeMake(frame.size.width - 4*margin, maxHeight)
            //                                 lineBreakMode:detailsLabel.lineBreakMode]; //Deprecated
