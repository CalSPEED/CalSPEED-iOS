...
-(void)setupWithBlock:(StartupCallback)callback {
    ...
    dispatch_async(self.setupQueue, ^{
        ...
        self->_hostRef = CFHostCreateWithName(NULL, (__bridge CFStringRef)self.host);
        
        BOOL success = CFHostStartInfoResolution(self->_hostRef, kCFHostAddresses, &streamError);
        ...
        NSArray *addresses = (__bridge NSArray *)CFHostGetAddressing(self->_hostRef, &resolved);
